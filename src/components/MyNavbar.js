            ...
            <Navbar color="faded bg-dark" dark expand="md">
                ...
                <Collapse isOpen={isOpen} navbar>
                    <Nav className="mr-auto" navbar>
                        <NavItem>
                            <NavLink href="/components/" color="light" light className="setlink"><svg width="16" height="16" viewBox="0 0 16 16" style={{ fill: "#fff", marginTop: "4px", marginRight: "4px" }}>
                        ...
                        <NavItem>
                            <NavLink href="https://github.com/reactstrap/reactstrap" className="setlink"><svg width="16" height="16" viewBox="0 0 16 16" style={{ fill: "#fff", marginTop: "4px", marginRight: "4px" }}>
